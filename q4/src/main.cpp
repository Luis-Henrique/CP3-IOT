...
const char* mqttUser     = "luis";
const char* mqttPassword = "fiap@2025";

// Tópico MQTT
#define TOPICO_PUBLISH  "CP3/IOT"
...
void loop() {
    ...
    // 3. Dados de sensores
    int temperatura = random(20, 36);
    int umidade     = random(40, 81);
    int pressao     = random(980, 1051);
    int altitude    = random(0, 501);
